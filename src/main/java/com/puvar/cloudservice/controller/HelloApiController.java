...
@RestController
public class HelloApiController implements HelloServiceApi {

    public String hello() {
        return null;
    }

    public String simpleHello(@RequestParam("name") String name) {
        return name;
    }


    public UserApi complexHello(@RequestBody UserApi user) {
        return user;
    }
}
*/
